...
imported from cpod <https://github.com/nmeum/cpod> and is licensed under
GNU GPLv3 (or later). Documentation is missing at the moment, the tests
are not completed yet and the API might still be subject to change.
